...
const RightSideBar = ({ showRightSideBar }: Props) => {
  ...
  return (
    <div className={`absolute right-0 flex flex-col border-l border-gray-200 card w-72 bg-white p-5 h-[calc(100vh-120px)] ${showRightSideBar ? 'translate-x-0' : 'translate-x-full'} transition-all duration-300 ease-in-out`}>
      <div className="mb-6">
